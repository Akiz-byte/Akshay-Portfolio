...
const projects = [
  ...
  },
  {
    id: 2,
    title: "OShi-chatapp",
    description: "A real-time messaging app designed for simple, fast, and secure communication.",
    technologies: ["ReactJS", "TailwindCSS", "Zustand","Axios", "Socket.io","DaisyUI","NodeJS","Cloudinary"],
    liveUrl: "#",
    githubUrl: "#",
    image: "./Oshi.png",
  },
  {
    id: 3,
    title: "Quizzo",
    description: "An AI-driven quiz generator that creates both multiple-choice and open-ended questions instantly.",
    technologies: ["NextJS","TypeScript", "Prisma","NextAuth", "Gemini API", "MongoDB","Zod"],
    liveUrl: "#",
    githubUrl: "#",
    image: "./quizzo.png",
  },
